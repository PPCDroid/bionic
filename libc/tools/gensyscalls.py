...
class State:
    ...
    def process_file(self,input):
        ...
        for t in self.syscalls:
            ...
            if t["id3"] >= 0:
                t["asm-mips"] = self.mips_genstub(syscall_func,len(syscall_params),"__NR_"+syscall_name)
	...
	dup_dict = {}
        for sc in self.syscalls:
            sc_func = sc["func"]
            if not dup_dict.has_key(sc_func):
                fp.write( sc["decl"]+"\n" )
		dup_dict[sc_func] = True
