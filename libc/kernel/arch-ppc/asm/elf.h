...
#define ARCH_DLINFO  do {       NEW_AUX_ENT(AT_IGNOREPPC, AT_IGNOREPPC);   NEW_AUX_ENT(AT_IGNOREPPC, AT_IGNOREPPC);       NEW_AUX_ENT(AT_DCACHEBSIZE, dcache_bsize);   NEW_AUX_ENT(AT_ICACHEBSIZE, icache_bsize);   NEW_AUX_ENT(AT_UCACHEBSIZE, ucache_bsize);   VDSO_AUX_ENT(AT_SYSINFO_EHDR, current->mm->context.vdso_base)  } while (0)
