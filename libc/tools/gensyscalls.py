...
#
powerpc_header = """/* autogenerated by gensyscalls.py */
#include <sys/linux-syscalls.h>
...
class State:
    ...
    def powerpc_genstub(self,fname, flags, idname):
        t = { "fname"  : fname,
              "idname" : idname }
        result  = powerpc_header % t
        result += powerpc_call % t
        return result
    ...
    def process_file(self,input):
        ...
        for t in self.syscalls:
            ...
            if t["cid"] >= 0 and (t["id"] >= 0 or t["id3"] >= 0  or t["id3"] >= 0):
            ...
            if t["id4"] >= 0:
                t["asm-powerpc"] = self.powerpc_genstub(syscall_func,len(syscall_params),"__NR_"+syscall_name)
    ...
    def gen_linux_syscalls_h(self):
        ...
        for sc in self.syscalls:
            ...
            sc_id4 = sc["id4"]
            sc_name = sc["name"]
            if sc_id == sc_id2 and sc_id == sc_id3 and sc_id == sc_id4 and sc_id >= 0:
        ...
        for sc in self.syscalls:
            ...
            sc_id4 = sc["id4"]
            sc_name = sc["name"]
            if (sc_id != sc_id2 or sc_id != sc_id3 or sc_id != sc_id4) and sc_id >= 0:
                self.gen_NR_syscall( fp, sc_name, sc_id )
        fp.write( "#endif\n" );
        ...
        for sc in self.syscalls:
            ...
            sc_id4 = sc["id4"]
            sc_name = sc["name"]
            if (sc_id2 != sc_id or sc_id2 != sc_id3 or sc_id2 != sc_id4) and sc_id2 >= 0 and sc_name not in gen_syscalls:
        ...
        for sc in self.syscalls:
            ...
            sc_id4 = sc["id4"]
            sc_name = sc["name"]
            if (sc_id3 != sc_id or sc_id3 != sc_id2 or sc_id3 != sc_id4) and sc_id3 >= 0:
                self.gen_NR_syscall( fp, sc_name, sc_id3 )
        fp.write( "#endif\n" );

        # all powerpc-specific syscalls
        ...
        for sc in self.syscalls:
            ...
            sc_id4 = sc["id4"]
            sc_name = sc["name"]
            if (sc_id4 != sc_id or sc_id4 != sc_id2 or sc_id4 != sc_id3) and sc_id4 >= 0:
                self.gen_NR_syscall( fp, sc_name, sc_id4 )
        fp.write( "#endif\n" );
    ...
    def gen_arch_syscalls_mk(self, arch):
        ...
        arch_test = {
            ...
            "powerpc": lambda x: x.has_key("asm-powerpc")
        }
    ...
    def gen_syscall_stubs(self):
        for sc in self.syscalls:
            ...
            if sc.has_key("asm-powerpc"):
                fname = "arch-powerpc/syscalls/%s.S" % sc["func"]
                D( ">>> generating "+fname )
                fp = create_file( fname )
                fp.write(sc["asm-powerpc"])
                fp.close()
                self.new_stubs.append( fname )
