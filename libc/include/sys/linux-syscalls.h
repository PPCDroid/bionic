...
#if !defined __ASM_ARM_UNISTD_H && !defined __ASM_I386_UNISTD_H && !defined __ASM_POWERPC_UNISTD_H && !defined __ASM_MIPS_UNISTD_H
...
#define __NR_setuid32                     (__NR_SYSCALL_BASE + 23)
#define __NR_getuid32                     (__NR_SYSCALL_BASE + 24)
#define __NR_getgid32                     (__NR_SYSCALL_BASE + 47)
#define __NR_geteuid32                    (__NR_SYSCALL_BASE + 49)
#define __NR_getegid32                    (__NR_SYSCALL_BASE + 50)
#define __NR_getresuid32                  (__NR_SYSCALL_BASE + 165)
#define __NR_getresgid32                  (__NR_SYSCALL_BASE + 170)
#define __NR_gettid                       (__NR_SYSCALL_BASE + 207)
#define __NR_getgroups32                  (__NR_SYSCALL_BASE + 80)
#define __NR_setgid32                     (__NR_SYSCALL_BASE + 46)
#define __NR_setreuid32                   (__NR_SYSCALL_BASE + 70)
#define __NR_setresuid32                  (__NR_SYSCALL_BASE + 164)
#define __NR_setresgid32                  (__NR_SYSCALL_BASE + 169)
#define __NR_kill                         (__NR_SYSCALL_BASE + 37)
#define __NR_tkill                        (__NR_SYSCALL_BASE + 208)
#define __NR_ugetrlimit                   (__NR_SYSCALL_BASE + 190)
#define __NR_setgroups32                  (__NR_SYSCALL_BASE + 81)
#define __NR_vfork                        (__NR_SYSCALL_BASE + 189)
#define __NR_setregid32                   (__NR_SYSCALL_BASE + 71)
#define __NR_prctl                        (__NR_SYSCALL_BASE + 172)
...
#define __NR_fchown32                     (__NR_SYSCALL_BASE + 95)
...
#define __NR_chown32                      (__NR_SYSCALL_BASE + 181)
...
#define __NR_sched_get_priority_min       (__NR_SYSCALL_BASE + 160)
#define __NR_sched_rr_get_interval        (__NR_SYSCALL_BASE + 161)
#define __NR_futex                        (__NR_SYSCALL_BASE + 241)
